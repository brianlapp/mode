        ...
        async loadCampaigns() {
            try {
                ...
                if (propertyCode) {
                    ...
                    // Pass property as query parameter to ensure correct campaigns
                    response = await fetch(`${CONFIG.API_BASE}/campaigns/by-host-optimized?property=${encodeURIComponent(propertyCode)}`);
                } else {
            ...
            return `
                ...
                <div style="padding: ${isDesktop ? '24px 32px' : '20px'}; padding-top: ${isDesktop ? '50px' : '70px'}; text-align: center;">
                    ...
                    <p style="
                        ...
                        font-size: 14px;
                        line-height: 1.4;
                        margin: ${isDesktop ? '12px 0 16px 0' : '12px 0 16px 0'};
                        text-align: center;
                    ...
                    <button class="mode-popup-cta" style="
                        ...
                        font-weight: 600;
                        cursor: pointer;
                        margin-bottom: ${isDesktop ? '8px' : '8px'};
                        transition: background 0.2s ease;
                    ...
                    <button class="mode-popup-next" style="
                        ...
                        font-weight: 500;
                        cursor: pointer;
                        margin-bottom: ${isDesktop ? '12px' : '8px'};
